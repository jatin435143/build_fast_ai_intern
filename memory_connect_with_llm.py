...
# Configure Gemini
genai.configure(api_key=os.environ.get("GEMINI_API_KEY"))  # safer than hardcoding

# Define Gemini wrapper
class GeminiLLM(LLM):
...
# Query and response
user_query = input("Write Query Here: ")[:1000]  # truncate long input
